...
main{
    ...
    obtiene la cordenada
    verifica la coordenada
    introduce la ficha
    mostrar el tablero
    verificar que ha ganado
...
public class tresEnRaya3 {
    public static void main(String[] args) {
        ...
        while (turno < 9 && !haGanado) {
            ...
            imprimirTablero(tablero);
            verificarGanador(tablero,jugador,haGanado,turno);
            turno++;
    ...
    public static void verificarGanador(String[][] tablero, String jugador,boolean haGanado,int turno) {
